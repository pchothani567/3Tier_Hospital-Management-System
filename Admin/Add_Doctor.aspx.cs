    ...
    public partial class Add_Doctor : System.Web.UI.Page
    {
        ...
        protected void Ad_doctor_Click(object sender, EventArgs e)
        {
            ...
            if (Ad_doctor.Text == "Add Doctor")
            {
                ...
                Response.Write("<script LANGUAGE='JavaScript' >alert('Doctor added successfully.')</script>");
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            da = new SqlDataAdapter("select * from Doctors", ad.startcon());
            ds = new DataSet();
            da.Fill(ds);
            ...
            Crypath = @"C:/Users/Admin/source/repos/Project_Hospital/Project_Hospital/Admin/DoctorCrystalReport1.rpt";
            ...
            cr.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "Doctor Detail Report");
        }
    }
}