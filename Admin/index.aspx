                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupport">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="FeedbackFormDetail_Show.aspx">Review Detail</a></li> 
...
--%>
   ...
   <%-- Pagination--%>
    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-primary ml-lg-3" OnClick="LinkButton3_Click">Previous</asp:LinkButton>
    ...
    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="btn btn-primary ml-lg-3"  OnClick="LinkButton4_Click">Next</asp:LinkButton>
