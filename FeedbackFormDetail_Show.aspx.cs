...
namespace Project_Hospital.Admin
{
    public partial class FeedbackFormDetail : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            da = new SqlDataAdapter("select * from Reviews", ads.startcon());
            ds = new DataSet();
            da.Fill(ds);
            ...
            Crypath = @"C:/Users/Admin/source/repos/Project_Hospital/Project_Hospital/Admin/ReviewCrystalReport.rpt";
            ...
            cr.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "Review Detail Report");
        }
    }
}