<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Register_User.aspx.cs" Inherits="Project_Hospital.Register_User" %>
...
<body>
    ...
    <asp:Button ID="btnRegister" runat="server" Text="Register" CssClass="register-btn" OnClick="Button1_Click"   />

    <div class="login-link">
                Already an Account? <a href="Login_User.aspx">Login</a>
            </div>
        </div>
    </body>
</html>
